...
class BarangController extends Controller
{
    ...
    public function update(Request $request, $id) {
        ...
        BarangModel::where('barang_id', $id)->update($request->all());
    ...
    public function destroy($id) {
        ...
        if (!$check) {
            return redirect()->route('barang.index')->with('error', 'Data yang Anda coba hapus tidak ditemukan');
        }
        ...
        try {
            ...
            return redirect('/user')->with('error', 'Data user bgagal dihapus karena masih terdapat tabel lain yang
            terait dnegan data ini');
        }
    }
}
