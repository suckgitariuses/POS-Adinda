    ...
    <li class="nav-item dropdown me-6"> {{-- Item dropdown dalam navbar dengan margin kanan --}}
        <a class="nav-link" data-toggle="dropdown" href="#" id="avatarDropdown">
            ...
            @if (auth()->user()->foto)
                ...
                <img src="{{ asset('storage/profile/GkLjFxVWAAAe_15.jpeg') }}" width="100" height="100">

                {{-- Foto profil user kecil --}}
            @else
                {{-- Jika user tidak punya foto --}}
                <img src="{{ asset('storage/profile/image.jpeg' . auth()->user()->foto) }}" width="100" height="100" alt="Foto Profil">
                {{-- Foto default --}}
            @endif
        </a>
